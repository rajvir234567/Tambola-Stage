...
def finishingBox():
    ...
    finishingBox = Label(gameWindow, text="Home", font=("Chalkboard SE", 30), width=6, height=2, borderwidth=0, bg="green", fg="white")
...
def gameWindow():
    ...
    rollButton = Button(gameWindow,text="Roll Dice", fg='black', font=("Chalkboard SE", 10), bg="grey",command=rollDice, width=20, height=5)
